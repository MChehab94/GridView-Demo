This is a simple demo that shows how to use GridView to display images using the [picasso transformations](https://github.com/wasabeef/picasso-transformations) library.  
